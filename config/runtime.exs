...
config :block_scout_web, :footer,
  ...
  github_link: System.get_env("FOOTER_GITHUB_LINK", "https://github.com/DTXNetwork/dtx-chain-explorer/"),
  forum_link_enabled: ConfigHelper.parse_bool_env_var("FOOTER_FORUM_LINK_ENABLED"),
  forum_link: System.get_env("FOOTER_FORUM_LINK", "https://github.com/DTXNetwork/dtx-chain-explorer/"),
